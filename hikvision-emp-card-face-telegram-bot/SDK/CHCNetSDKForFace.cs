...
namespace FaceManagement
{
    class CHCNetSDKForFace
    {
        ...
        {
            public int dwSize;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = CHCNetSDKForFace.ACS_CARD_NO_LEN)]
            ...
            public void init() 
            {
                byCardNo = new byte[CHCNetSDKForFace.ACS_CARD_NO_LEN];
                byRes = new byte[124];
            }
        }
        ...
        {
            public int dwSize;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst =CHCNetSDKForFace.ACS_CARD_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardNo;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst =CHCNetSDKForFace.ERROR_MSG_LEN, ArraySubType = UnmanagedType.I1)]
            ...
            {
                byCardNo=new byte[CHCNetSDKForFace.ACS_CARD_NO_LEN];
                byErrorMsg=new byte[CHCNetSDKForFace.ERROR_MSG_LEN];
                byRes=new byte[131];
            }
        }
        ...
        public struct NET_DVR_FACE_PARAM_CTRL_CARDNO
        {
            ...
            public byte[] byRes1;
            public CHCNetSDKForFace.NET_DVR_FACE_PARAM_BYCARD struByCard;//按卡号的方式删除,读卡器暂时不写
        ...
        public struct NET_DVR_FACE_PARAM_BYCARD
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst =CHCNetSDKForFace.MAX_CARD_READER_NUM_512, ArraySubType = UnmanagedType.I1)]
            public byte[] byEnableCardReader;//人脸的读卡器信息，按数组表示
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst =CHCNetSDKForFace.MAX_FACE_NUM, ArraySubType = UnmanagedType.I1)]
            ...
            {
                byCardNo = new byte[CHCNetSDKForFace.ACS_CARD_NO_LEN];
                byEnableCardReader=new byte[CHCNetSDKForFace.MAX_CARD_READER_NUM_512];
                byFaceID = new byte[CHCNetSDKForFace.MAX_FACE_NUM];
                byRes1 = new byte[42];
            }
        }
        ...
        [DllImport(@"..\..\..\HCNetSDK\HCNetSDK.dll")]
        public static extern int NET_DVR_GetNextRemoteConfig(int lHandle, ref CHCNetSDKForFace.NET_DVR_FACE_RECORD lpOutBuff, int dwOutBuffSize);

        [DllImport(@"..\..\..\HCNetSDK\HCNetSDK.dll")]
        public static extern int NET_DVR_StopRemoteConfig(int lHandle);

        [DllImport(@"..\..\..\HCNetSDK\HCNetSDK.dll")]
        public static extern int NET_DVR_SendWithRecvRemoteConfig(int lHandle, ref CHCNetSDKForFace.NET_DVR_FACE_RECORD lpInBuff, int dwInBuffSize, ref CHCNetSDKForFace.NET_DVR_FACE_STATUS lpOutBuff, int dwOutBuffSize, IntPtr dwOutDataLen);

        [DllImport(@"..\..\..\HCNetSDK\HCNetSDK.dll")]
        public static extern bool NET_DVR_RemoteControl(int lUserID, int dwCommand, ref CHCNetSDKForFace.NET_DVR_FACE_PARAM_CTRL_CARDNO lpInBuffer, int dwInBufferSize);

        [DllImport(@"..\..\..\HCNetSDK\HCNetSDK.dll")]
        public static extern int NET_DVR_GetNextRemoteConfig(int lHandle, ref CHCNetSDKForFace.NET_DVR_CAPTURE_FACE_CFG lpOutBuff, int dwOutBuffSize);
        #endregion
    }
}
